...
void menu(){
    ...
    printf("- 7 : Chercher les livres par auteurs\n");
    printf("- 8 : Enregistrer la bibliotheque dans un fichier\n");
    printf("Action : ");
}


int main(int argc,char **argv){
    BiblioH *res = charger_n_entrees(argv[1],atoi(argv[2]));
    BiblioH *recep_fusion;
    int rep;
    LivreH *recep;
    char *titre;
    char *auteur;
        ...
        switch (rep){
            ...
            case 1 :
                ...
                case 6 :
                    ...
                    break;
                case 7 :
                    printf("Ecrivez le nom de l'auteur : ");
                    scanf("%s",auteur);
                    recep_fusion = chercher_par_auteur(res,auteur);
                    afficher_biblio(recep_fusion);
                    libererBiblio(recep_fusion);
                    break;
                case 8 :
