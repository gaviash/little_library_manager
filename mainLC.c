...
/*ajouter l'option 8 : chercher par auteur,qui cree la bibli d'auteur,l'affiche,et on la free avec la fonction liberer biblio
En table de hachage c'est pareil*/
